#!/usr/bin/env python3
"""
TCN v3b — ABLATION: wider window only (WINDOW=16, BLOCKS=3).
Compared to v2: same BLOCKS=3 and DILATIONS=[1,2,4], but WINDOW 8→16.

This isolates the contribution of LONGER CONTEXT.
"""
...
DROPOUT     = 0.3
CLIP_VAL    = 10.0
# TCN config — SAME as v2
N_BLOCKS    = 3                                # SAME as v2
CHANNELS    = 64
KERNEL_SIZE = 3
DILATIONS   = [1, 2, 4]                        # SAME as v2
...
lines = [
    ...
    "=" * 72,
    f"Ablation: wider window only (vs v2)",
    f"Window: {WINDOW} (v2=8)  |  Blocks: {N_BLOCKS} (SAME)  |  Dilations: {DILATIONS}",
