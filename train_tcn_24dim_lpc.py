#!/usr/bin/env python3
"""24 维 = 27 - {length (idx 2), press_mean_w (idx 19), crc_mean_w (idx 20)} retrain 5-seed 验证
...
LOO 加总预测: +0.0051 + 0.0035 + 0.0010 = +0.0096
期望 F1m >= 0.8205 + 0.0096 = 0.8301
"""
...
print(f"=== TCN+SE 24-dim (-length, -press_mean_w, -crc_mean_w) Retrain 5-seed ===")
print(f"去除特征: {DROP}")
...
print("\n=== 24-dim (-length, -press_mean_w, -crc_mean_w) 5-seed ===")
results = []
for seed in SEEDS:
...
print("\n" + "="*80)
print("=== 24-dim (-length, -press_mean_w, -crc_mean_w) 5-seed 汇总 ===")
print("="*80)
...
print(f"  LOO 加总预测:        DeltaF1m >= +0.0096 (= +0.0051 + 0.0035 + 0.0010)")
...
out_json = os.path.join(BASE, "train_tcn_24dim_lpc_results.json")
